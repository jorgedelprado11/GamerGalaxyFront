...
const productForm = () => {
 ...
 const  [iva,setIva]=useState();
  ...
  className="text-black mb-10 w-80 h-6 rounded-md transition duration-300 hover:ring-2 hover:ring-blue-500 hover:border-blue-500 mb-10" 
/>
      </div>
      </div>
      <div className="text-center">
...
>
  ...
  {categorias?.map((categoria, index) => (
    <option key={index} value={categoria.id_categorias} className="text-black mb-2 w-80 h-6rounded-md transition duration-300 hover:ring-2 hover:ring-blue-500 hover:border-blue-500" >
      {categoria.categoria}
    </option>
  ))}
</select>
...
<div className="text-center">
  ...
  <div className="flex flex-col items-center ">
    ...
    />
      ...
      <div className="text-center">
      <div className='flex flex-col items-center'>
        <button type="submit" className='bg-green-700'>Crear Producto</button>
      </div>
      </div>
    </form>
  </div>
